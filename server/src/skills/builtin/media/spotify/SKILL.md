...
Control the user's Spotify account via the dasha Spotify toolset (7 tools). Setup guide: https://dasha-agent.nousresearch.com/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `dasha auth spotify` again.
