...
Built for [dasha Agent](https://github.com/NousResearch/dasha-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/dasha-agent/skills/creative/ascii-video`](https://github.com/NousResearch/dasha-agent/tree/main/skills/creative/ascii-video) via PR.
