...
```bash
python3 -m pyfiglet "dasha" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=dasha&font=Slant" | boxes -d stone
```
