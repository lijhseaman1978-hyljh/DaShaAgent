...
```python
import sys
sys.path.insert(0, "/home/teknium/.dasha/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.dasha/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — dasha installs package this)
