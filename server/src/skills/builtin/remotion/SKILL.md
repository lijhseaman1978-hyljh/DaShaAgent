...
Use this skill when the user wants dasha to turn a short video idea into an editable, renderable React video project with Remotion.
...
```bash
dasha skills install skills-sh/google-labs-code/stitch-skills/remotion
```
