...
This skill is designed for the dasha agent. It uses dasha tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other dasha skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.dasha/plans/` | `skill_view("plan")` |
